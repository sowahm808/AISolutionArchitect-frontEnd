...
export const routes: Routes = [
  ...
  { path: "register", component: RegisterComponent },
  {
    ...
    children: [
      ...
      { path: "projects/:projectId/export", component: SimplePageComponent, data: { simplePage: "export" }, canActivate: [roleGuard(["Admin", "Architect"])] },
      { path: "profile", component: ProfileComponent },
      {
        path: "settings/organization",
        component: SimplePageComponent,
        data: { simplePage: "organization" },
        canActivate: [roleGuard(["Admin", "Architect"])],
      },
      {
        path: "settings/users",
        component: SimplePageComponent,
        data: { simplePage: "users" },
        canActivate: [roleGuard(["Admin"])],
      },
      {
        path: "audit-logs",
        component: SimplePageComponent,
        data: { simplePage: "auditLogs" },
        canActivate: [roleGuard(["Admin"])],
      },
